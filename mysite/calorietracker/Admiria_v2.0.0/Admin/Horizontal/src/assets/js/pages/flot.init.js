  ...
  FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
    ...
    tooltipOpts : {
      ...
      FlotChart.prototype.init = function() {
        ...
        var pcolors = ['#009688', '#fb8c00','#6d60b0'];
        ...
        var datas = [20,30, 15];
        var colors = ['#f06292', '#4ac18e', "#ebeff2"];
        this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


          //real time data representation
          var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#3bc3e9']);
          plot.draw();
          var $this = this;
          function updatePlot() {
        ...
        var donutcolors = ['#5468da', '#ffbb44', "#67a8e4"];
